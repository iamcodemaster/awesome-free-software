...
### Video
- [Remove Audio](https://remove-audio.com) — Free browser-based tool to strip audio from video files. Runs locally via WebAssembly and FFmpeg.wasm. No uploads, no account, no watermarks.
